...
QT_MOC_LITERAL(1, 11, 17), // "SignalShowAccount"
...
void MyComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyComboBox::SignalShowAccount)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyComboBox::SignalRemoveItem)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyComboBox::SignalShowAccount(QString _t1)
{
...
// SIGNAL 1
void MyComboBox::SignalRemoveItem(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
